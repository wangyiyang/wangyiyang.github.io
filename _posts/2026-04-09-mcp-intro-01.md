...
mindmap: false
mindmap2: false
cover: "/images/posts/post_function-declaration-and-function-implementation_001.webp"
permalink: /2026/04/09/mcp-intro-01/
---
...
**🔗 完整代码仓库**: [`./mcp-guide/`](./mcp-guide/) - 包含本文所有示例的完整实现
**📖 实战教程**: [MCP开发入门02](./MCP开发入门02.md) - 动手搭建第一个MCP服务器
**🏗️ 项目模板**: [`./mcp-guide/templates/`](./mcp-guide/templates/) - 可直接使用的项目脚手架
